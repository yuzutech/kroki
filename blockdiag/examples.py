...
@enduml
"""
sample('plantuml', plantuml_bob_alice)
...
"""
sample('plantuml', plantuml_checkout)
...
"""
sample('rackdiag', rackdiag_sample)
...
"""
sample('packetdiag', packetdiag_sample)
...
"""
sample('blockdiag', blockdiag_sample)
...
"""
sample('graphviz', graphviz_clusters)
...
sample('graphviz', graphviz_unix)

graphviz_hello = """digraph G {Hello->World}"""
sample('graphviz', graphviz_hello)
...
"""
print('\n=== C4 Context')
sample('c4plantuml', context_bigbank)
...
"""
print('\n=== C4 Container')
sample('c4plantuml', container_bigbank)
...
"""
print('\n=== C4 Component')
sample('c4plantuml', comp_bigbank)
...
"""
sample('nomnoml', nomnoml_sample)

# Mermaid
section('Mermaid')
mermaid_flowchart_sample="""
graph TD;
    A-->B;
    A-->C;
    B-->D;
    C-->D;
"""
sample('mermaid', mermaid_flowchart_sample)

mermaid_seqdiag_sample="""
sequenceDiagram
    participant Alice
    participant Bob
    ...
    Bob-->John: Jolly good!
"""
sample('mermaid', mermaid_seqdiag_sample)
...
gantt
        ...
        Add to mermaid                      :1d
"""
sample('mermaid', mermaid_gant_sample)
...
print('\n=== Analysis')
print('/umlet/svg/' + encode(umlet_analysis))
...
print('\n=== Object')
print('/umlet/svg/' + encode(umlet_object))
...
print('\n=== Struct')
print('/umlet/svg/' + encode(umlet_struct))
...
print('\n=== Sequence')
print('/umlet/svg/' + encode(umlet_seq))
...
print('\n=== State')
print('/umlet/svg/' + encode(umlet_state))
...
print('\n=== Simple state')
print('/umlet/svg/' + encode(umlet_state_simple))
