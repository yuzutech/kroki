...
/**
   ...
   */
function(e){const t=$e('<a href="http://bpmn.io" target="_blank" class="bjs-powered-by" title="Powered by bpmn.io" >'+Tr+"</a>");Se(He("svg",t),Or),Se(t,Nr,{position:"absolute",bottom:"15px",right:"15px",zIndex:"100"}),e.appendChild(t),Ie.bind(t,"click",(function(e){jr(),e.preventDefault()}))}(this._container),this._init(this._container,this._moddle,e)}function Wr(e,t){return e.warnings=t,e}e(Vr,ci),Vr.prototype.importXML=async function(e,t){const n=this;let i=[];try{let o;e=this._emit("import.parse.start",{xml:e})||e;try{o=await this._moddle.fromXML(e,"bpmn:Definitions")}catch(e){throw this._emit("import.parse.complete",{error:e}),e}let a=o.rootElement;const s=o.references,l=o.warnings,p=o.elementsById;i=i.concat(l),a=this._emit("import.parse.complete",(r={error:null,definitions:a,elementsById:p,references:s,warnings:i},n.get("eventBus").createEvent(r)))||a;const c=await this.importDefinitions(a,t);return i=i.concat(c.warnings),this._emit("import.done",{error:null,warnings:i}),{warnings:i}}catch(e){let t=e;throw i=i.concat(t.warnings||[]),Wr(t,i),t=function(e){const t=/unparsable content <([^>]+)> detected([\s\S]*)$/.exec(e.message);t&&(e.message="unparsable content <"+t[1]+"> detected; this may indicate an invalid BPMN 2.0 diagram file"+t[2]);return e}(t),this._emit("import.done",{error:t,warnings:t.warnings}),t}var r},Vr.prototype.importDefinitions=async function(e,t){this._setDefinitions(e);return{warnings:(await this.open(t)).warnings}},Vr.prototype.open=async function(e){const t=this._definitions;let n=e;if(!t){const e=new Error("no XML imported");throw Wr(e,[]),e}if("string"==typeof e&&(n=function(e,t){if(!t)return null;return c(e.diagrams,(function(e){return e.id===t}))||null}(t,e),!n)){const t=new Error("BPMNDiagram <"+e+"> not found");throw Wr(t,[]),t}try{this.clear()}catch(e){throw Wr(e,[]),e}const{warnings:i}=await kr(this,t,n);return{warnings:i}},Vr.prototype.saveXML=async function(e){e=e||{};let t,n,i=this._definitions;try{if(!i)throw new Error("no definitions loaded");i=this._emit("saveXML.start",{definitions:i})||i;n=(await this._moddle.toXML(i,e)).xml,n=this._emit("saveXML.serialized",{xml:n})||n}catch(e){t=e}const r=t?{error:t}:{xml:n};if(this._emit("saveXML.done",r),t)throw t;return r},Vr.prototype.saveSVG=async function(){let e,t;this._emit("saveSVG.start");try{const t=this.get("canvas"),n=t.getActiveLayer(),i=He("defs",t._svg),r=re(n),o=i?"<defs>"+re(i)+"</defs>":"",a=n.getBBox();e='<?xml version="1.0" encoding="utf-8"?>\n\x3c!-- created with bpmn-js / http://bpmn.io --\x3e\n<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="'+a.width+'" height="'+a.height+'" viewBox="'+a.x+" "+a.y+" "+a.width+" "+a.height+'" version="1.1">'+o+r+"</svg>"}catch(e){t=e}if(this._emit("saveSVG.done",{error:t,svg:e}),t)throw t;return{svg:e}},Vr.prototype._setDefinitions=function(e){this._definitions=e},Vr.prototype.getModules=function(){return this._modules},Vr.prototype.clear=function(){this.getDefinitions()&&ci.prototype.clear.call(this)},Vr.prototype.destroy=function(){ci.prototype.destroy.call(this),Ke(this._container)},Vr.prototype.on=function(e,t,n,i){return this.get("eventBus").on(e,t,n,i)},Vr.prototype.off=function(e,t){this.get("eventBus").off(e,t)},Vr.prototype.attachTo=function(e){if(!e)throw new Error("parentNode required");this.detach(),e.get&&e.constructor.prototype.jquery&&(e=e.get(0)),"string"==typeof e&&(e=He(e)),e.appendChild(this._container),this._emit("attach",{}),this.get("canvas").resized()},Vr.prototype.getDefinitions=function(){return this._definitions},Vr.prototype.detach=function(){const e=this._container,t=e.parentNode;t&&(this._emit("detach",{}),t.removeChild(e))},Vr.prototype._init=function(e,t,n){const i=n.modules||this.getModules(n),r=n.additionalModules||[],o=[].concat([{bpmnjs:["value",this],moddle:["value",t]}],i,r),a=E(function(e,t){let n={};return h(Object(e),(function(e,i){-1===t.indexOf(i)&&(n[i]=e)})),n}(n,["additionalModules"]),{canvas:E({},n.canvas,{container:e}),modules:o});ci.call(this,a),n&&n.container&&this.attachTo(n.container)},Vr.prototype._emit=function(e,t){return this.get("eventBus").fire(e,t)},Vr.prototype._createContainer=function(e){const t=$e('<div class="bjs-container"></div>');return Se(t,{width:Gr(e.width),height:Gr(e.height),position:e.position}),t},Vr.prototype._createModdle=function(e){return new Rr(E({},this._moddleExtensions,e.moddleExtensions))},Vr.prototype._modules=[];const zr={width:"100%",height:"100%",position:"relative"};function Gr(e){return e+(a(e)?"px":"")}function $r(e){Vr.call(this,e)}return e($r,Vr),$r.prototype._modules=[_t,ht,Gt,Xt,yn],$r.prototype._moddleExtensions={},$r}));
