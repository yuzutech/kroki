...
class DiagramSourceTest {
  ...
  @Test
  void should_throw_when_source_encoded_is_empty() {
  ...
  @Test
  void should_throw_when_source_encoded_is_null() {
  ...
  @Test
  void should_throw_when_source_encoded_only_contains_spaces() {
    assertThatThrownBy(() -> DiagramSource.decode("    "))
      .isInstanceOf(DecodeException.class)
      .hasMessageContaining("Unable to decode the source.");
  }
  ...
  @Test
  void should_throw_when_source_encoded_is_invalid() {
  ...
  @Test
  void should_throw_when_source_is_not_utf8_encoded() {
  ...
  @Test
  void should_decode_valid_plantuml_encoded_source_with_plantuml_encoder() throws DecodeException {
  ...
  @Test
  void should_decode_valid_plantuml_encoded_source_with_default_encoder() throws DecodeException {
