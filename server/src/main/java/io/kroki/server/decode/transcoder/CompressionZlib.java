...
import io.kroki.server.decode.transcoder.deflate.ByteBitInputStream;
import io.kroki.server.decode.transcoder.deflate.Decompressor;
...
public class CompressionZlib implements Compression {
  ...
  private static final boolean USE_ZOPFLI = false;
