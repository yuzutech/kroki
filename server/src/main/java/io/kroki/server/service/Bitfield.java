...
public class Bitfield implements DiagramService {
  ...
  public Bitfield(Vertx vertx, JsonObject config, Commander commander) {
    this.vertx = vertx;
    this.binPath = config.getString("KROKI_BITFIELD_BIN_PATH", "bitfield");
