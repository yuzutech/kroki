...
public class HelloHandler {
  ...
  public Handler<RoutingContext> create() {
    return routingContext -> {
      ...
      serviceVersions.add(new ServiceVersion("bytefield", "1.4.3"));
      serviceVersions.add(new ServiceVersion("c4plantuml", "1.2020.10"));
      ...
      serviceVersions.add(new ServiceVersion("mermaid", "8.5.1"));
      ...
      serviceVersions.add(new ServiceVersion("plantuml", "1.2020.10"));
      ...
      serviceVersions.add(new ServiceVersion("vega", "5.12.1"));
      serviceVersions.add(new ServiceVersion("vegalite", "4.12.2"));
