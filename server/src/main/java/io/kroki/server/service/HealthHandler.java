...
public class HealthHandler {
  ...
  public HealthHandler() {
    ...
    serviceVersions.add(new ServiceVersion("bpmn", "7.4.0"));
    ...
    serviceVersions.add(new ServiceVersion("excalidraw", "f2135ab"));
    ...
    serviceVersions.add(new ServiceVersion("plantuml", "1.2020.19"));
