...
public class HealthHandler {
  ...
  public HealthHandler() {
    ...
    serviceVersions.add(new ServiceVersion("bpmn", "8.2.0"));
    serviceVersions.add(new ServiceVersion("bytefield", "1.5.0"));
    serviceVersions.add(new ServiceVersion("c4plantuml", "1.2021.1"));
    ...
    serviceVersions.add(new ServiceVersion("mermaid", "8.9.0"));
    ...
    serviceVersions.add(new ServiceVersion("vega", "5.19.1"));
