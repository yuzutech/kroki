...
public class HealthHandler {
  ...
  public HealthHandler() {
    ...
    serviceVersions.add(new ServiceVersion("bpmn", "7.4.1"));
    serviceVersions.add(new ServiceVersion("bytefield", "1.5.0"));
    serviceVersions.add(new ServiceVersion("c4plantuml", "1.2020.20"));
    ...
    serviceVersions.add(new ServiceVersion("mermaid", "8.8.3"));
    ...
    serviceVersions.add(new ServiceVersion("plantuml", "1.2020.20"));
    ...
    serviceVersions.add(new ServiceVersion("vega", "5.17.0"));
