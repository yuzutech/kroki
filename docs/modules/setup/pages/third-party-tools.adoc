...
:url-mediawiki-kroki-extension: https://www.mediawiki.org/wiki/Extension:Kroki
...
There is a {url-mediawiki-kroki-extension}[MediaWiki Kroki extension]. This way you can easily integrate diagrams into wiki pages while benefiting from revision control for those diagrams.
