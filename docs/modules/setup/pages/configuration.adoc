...
TIP: The most browsers support >64k, also newer Edge, but that's a bit excessive so start with lower value.
If you're supporting Edge 16 then the max value should be 10240, for IE 11 not more than 5120.
