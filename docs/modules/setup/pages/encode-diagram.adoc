...
Also see the Tcl package {uri-dia2kroki}[dia2kroki] which has proceudres to both decode and encode the diagram source code and a GUI to create diagrams and see the result directly. 
